...
/**
 * 
 * Contains functions and variables relevant to controlling the drive of the robot
 *
 */
public class RobotDriveController {
	...
	/**
	 * Initializes the drive - sets motor ports
	 * and inverts the motors so the steering is natural
	 */
	...
	/**
	 * Function to be called periodically that sends joystick inputs to the drive
	 */
