 ...
 * While a hardware solution is feasible, we temporarily decided to go with a software solution
 * 
 **/
public class AutonomousController {
	...
	/**
	 * Sets the value of the 'current' variable to the necessary autonomous program
	 */
	static {
